...
@interface GPUImageFacePointFilter2()
{
...
@implementation GPUImageFacePointFilter2
...
//        0.193451, 0.291448
    ...
    for (int i = 0; i < points2.size(); i++) {
        points2[i] /= (float)2048.0;
    }
    if (_smallFaceDegree > 0.5) {
        pointFilter->setPoints(points.data(), points.size() / 2, 0.0, 0.0, 1.0);
    } else {
        pointFilter->setPoints(points2.data(), points2.size() / 2, 0.0, 0.0, 1.0);
    }
}
